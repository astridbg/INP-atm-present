...
print(ceres_data.toa_sw_all_mon)
print(ceres_data.solar_mon)
#-------------------------------------
...
print(A21.time)
print(A21_Aavg['FSNT'].values)
print(ceres_Aavg['toa_sw_all_mon'].values)
ceres_net_sw = ceres_Aavg['solar_mon'].values-ceres_Aavg['toa_sw_all_mon'].values

# Shortwave bias allsky
plt.figure(figsize=[13,4])
plt.plot(ceres_Aavg.time, A21_Aavg['FSNT'].values-ceres_net_sw, label='A21', color='tab:orange')
plt.plot(ceres_Aavg.time, M92_Aavg['FSNT'].values-ceres_net_sw, label='M92', color='tab:blue', linestyle='--')
plt.legend(loc="lower right")
plt.xticks(rotation=45, ha='right')
plt.ylabel(r'W/m$^2$')
plt.grid(alpha=0.5)
plt.savefig(fig_path+'pdf/sw_toa_bias_all.pdf', bbox_inches="tight")
plt.savefig(fig_path+'png/sw_toa_bias_all.png', bbox_inches="tight")
plt.clf()

quit()
# Shortwave bias clouds
...
plt.ylabel(r'W/m$^2$')
plt.grid(alpha=0.5)
plt.savefig(fig_path+'pdf/sw_bias_clouds.pdf', bbox_inches="tight")
plt.savefig(fig_path+'png/sw_bias_clouds.png', bbox_inches="tight")
plt.clf()

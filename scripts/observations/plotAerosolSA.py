...
df_opc["Total Surface Area"].plot(ax=axs[1,0],label="Particles $\geq 0.5 \mu$m",zorder=1)
axs[1,0].scatter(df_frzT.index,sfc_all,color="orange",zorder=2)
...
axs[1,0].set_ylabel("m$^2$/L$_{std}$")
axs[1,0].set_xlabel(None)
axs[1,0].set_title("Total Surface Area of Aerosols")
...
axs[1,1].scatter(t50,sfc_all,color="orange")
axs[1,1].grid(alpha=0.5)
axs[1,1].set_ylabel("m$^2$/L$_{std}$")
axs[1,1].set_yscale("log")
axs[1,1].annotate("R: %.2f, R$^2$: %.2f" %(functions.r(t50,sfc_all),functions.rsquared(t50,sfc_all)),
                xy=(0, 1), xycoords='axes fraction',
